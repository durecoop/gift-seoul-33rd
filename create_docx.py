...
items = [
    ...
    ('5차', '18주 (4/27~5/1)', '맛있는 손질고등어', '-', '손질 완료 / 신선'),
...
sched = [
    ...
    ('5차 (18주)', '4/27(월) ~ 5/1(금)', '맛있는 손질고등어 (마지막)'),
]
...
promo = [
    ...
    ('전화 안내', '온라인 미가입 조합원 개별 전화\n가입/주문 방법 안내 + 자녀 안내 권유', '3/25~3/30', '매장운영팀'),
]
...
add_run(p, (
    ...
    '5차(18주) 맛있는 손질고등어 - 주말 밥상에 고등어구이 한 점\n\n'
    '[카드 9 - 마무리]\n'
...
budget = [
    ...
    ('5차 맛있는 손질고등어', '7,600원', '50개', '380,000원'),
    ('홍보물 제작비', '-', '-', '200,000원'),
    ('총 예산', '', '', '1,230,000원'),
]
